		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					...
					React.createElement(RandomBox, { GiftList: this.state.data, PlayerList: this.state.PlayerList, PlayerNumber: this.state.PlayerNumber, BackDoorList: this.state.backDoorList, PlayerNumber: this.state.PlayerNumber })
				)
			)
		);
	}
